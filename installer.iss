...
[Files]
Source: "dist\betterNJUVPN\betterNJUVPN.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\betterNJUVPN\betterNJUVPN-cli.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\betterNJUVPN\README.md"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\betterNJUVPN\RELEASE_NOTES.md"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\betterNJUVPN\config.example.json"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\betterNJUVPN\assets\betterNJUVPN.ico"; DestDir: "{app}\assets"; Flags: ignoreversion
Source: "dist\betterNJUVPN\tools\mihomo\mihomo-windows-amd64-compatible.exe"; DestDir: "{app}\tools\mihomo"; Flags: ignoreversion
Source: "dist\betterNJUVPN\tools\mihomo\LICENSE"; DestDir: "{app}\tools\mihomo"; Flags: ignoreversion
